...
import { z } from 'zod';
import { Search, Plus, Pencil, Trash2, UserCog, ShieldCheck, ShieldOff } from 'lucide-react';
...
export default function Users() {
  ...
  return (
    <div>
      <PageHeader
        title="Users"
        description={`${meta.total} team members`}
        actions={
          me?.role === 'super_admin' && (
      ...
      <div className="bg-white dark:bg-white/[0.03] rounded-2xl border border-slate-200/70 dark:border-white/10 shadow-card overflow-hidden">
        ...
        {loading ? (
          ...
          <EmptyState icon={UserCog} title="No users yet" description="Add team members to collaborate." />
        ) : (
